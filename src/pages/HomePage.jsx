    ...
    <div className="px-4 pt-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[16px] text-primary">Welcome</p>
            <p className="text-[13px] text-zinc-500">Welcome home, {user.firstName}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex h-9 w-9 items-center justify-center rounded-full border border-border bg-surface text-[13px] font-medium text-primary">
            {initials}
          </div>
        </div>
      </header>
        ...
        <>
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h2 className="mt-1 text-[20px] font-bold text-bg">{nextEvent.name}</h2>
                ...
                <div className="flex h-12 w-12 flex-col items-center justify-center rounded-xl bg-[#f0f0f0] leading-none text-bg">
                  ...
                  <span className="mt-0.5 text-[11px] uppercase leading-none">{nextEvent.month}</span>
                </div>
              </div>
          ...
          <section className="mt-6">
            <div className="flex items-center justify-between">
              <h3 className="text-[13px] font-medium text-primary">Upcoming events</h3>
              <button type="button" onClick={() => navigate('/events')} className="text-[13px] text-zinc-500">
                See all
              </button>
            </div>
      ...
      <section className="mt-6 pb-6">
        <div className="flex items-center justify-between">
          <h3 className="text-[13px] font-medium text-primary">Announcements</h3>
          <button type="button" onClick={() => navigate('/news')} className="text-[13px] text-zinc-500">
            See all
          </button>
        </div>
        <div className="mt-3 rounded-xl border border-border bg-surface p-4">
          <p className="text-[16px] text-primary">{announcement.title}</p>
          <p className="mt-1 text-[14px] text-zinc-500">{announcement.body}</p>
        </div>
      </section>
    </div>
  )
