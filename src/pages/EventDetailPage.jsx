...
export default function EventDetailPage() {
  ...
  return (
    <div className="min-h-dvh bg-bg px-4 pt-6 pb-8">
      ...
      <div className="relative mt-4 h-[100px] rounded-[14px] bg-surface">
      ...
      <div className="mt-6">
        {event.type === 'midweek' ? (
          ...
          <button
            ...
            onClick={handleRsvp}
            disabled={going}
            className={`flex w-full items-center justify-center gap-2 rounded-xl py-3.5 text-base font-medium transition-colors ${
