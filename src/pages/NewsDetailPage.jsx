...
export default function NewsDetailPage() {
  ...
  if (!item) {
    return (
      <div className="px-4 pt-6">
        <BackRow label="News" />
        <p className="mt-4 text-sm text-zinc-500">News item not found.</p>
      </div>
    )
  }
  ...
  return (
    <div className="px-4 pt-6 pb-8">
      ...
      <h1 className="mt-3 text-lg text-primary">{item.title}</h1>
      <p className="mt-3 text-[11px] leading-[1.6] text-zinc-400">{item.body}</p>
    </div>
  )
}
